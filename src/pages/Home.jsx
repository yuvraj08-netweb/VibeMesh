                        ...
                        <>
                          <div className="userLoggedIn flex flex-col tems-center gap-2">
                            <div className="userInfo flex items-center gap-4">
                              <div className="userPP ">
                                <ProfileImage imgSrc={userDetails.avatar} />
                              </div>
              ...
              <div className="aboutRight md:w-[50%] md:mt-0 mt-20">
                ...
                >
                  ...
                  <p className="my-10 ">
                    ...
                    platform is designed to make conversations seamless,
                    intuitive, and fun. Whether you`re catching up with friends,
                    collaborating with colleagues, or building new communities,
                    VibeMesh offers a secure and vibrant space to share ideas
                    and stay in touch. With easy-to-use features, personalized
                    settings, and a focus on user privacy, we aim to create an
                    engaging experience where every interaction counts. Join the
                    vibe and mesh with the world!
                  </p>
                  <Button
                    btnText={"Get Started!"}
                    path={"/signup"}
          ...
          <footer className="Footer bg-darkPurple !text-lightPurple">
            <div className="container mx-auto justify-between items-center p-5 py-20 grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 text-center">
              ...
              <div className="footerCenterTwo md:mt-0 mt-10">
                <h3 className="mb-8 border-b-2 max-w-max mx-auto">
                  Usefull Links
                </h3>
                <ul>
                  <li>
